...
<nav id="sidebar">
    <div class="sidebar_blog_1">
        <div class="sidebar-header">
            <div class="logo_section">
                <a href="index.html"><img class="logo_icon img-responsive" src="View/images/logo/logo_icon.png"
                        alt="#" /></a>
            </div>
        </div>
        <div class="sidebar_user_info">
            ...
            <div class="user_profle_side">
                <div class="user_img"><img class="img-responsive" src="View/images/layout_img/user_img.jpg" alt="#" /></div>
                <div class="user_info">
                    <h6>John David</h6>
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            ...
            <li><a href="View/Contenidos/form_p.php"><i class="fa fa-table purple_color2"></i> <span>Registro de hoja de vida</span></a></li>
            <li>
            ...
            <li><a href="View/Contenidos/form_edit.php"><i class="fa fa-briefcase blue1_color"></i> <span>Edición hoja de vida</span></a></li>
            <li>
                <a href="contact.html">
