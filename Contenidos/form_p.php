...
<body>
    <section class="container"><!--readonly="readonly"-->
        <header>Registro de hoja de vida</header>
...
while($consulta_user = mysqli_fetch_assoc($result_user)){
    ?>
        ...
        <form action="../../Controller/registrar.php" class="form" method="post">
            ...
            <div class="input-box">
                <label>Experiencia anterior:</label><br>
